...
public class RegisterServlet extends HttpServlet {
	...
	/*
	 * init() service() and destroy() from the service() method doPost(), doGet(),
	 * doHead(), doDelete(), doOptions() and doTrace() HTTP callback methods are
	 * called
	 */
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// setting MIME type (Multipurpose Internet Mail Extension)
		// this will tell the browser what type of response we are // sending from
		// servlet
